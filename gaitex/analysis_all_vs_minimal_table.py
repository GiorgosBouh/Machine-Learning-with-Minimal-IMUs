...
IN_CSV = Path("output") / "features" / "task_complexity_folds_all_vs_minimal.csv"
OUT_CSV = Path("output") / "features" / "all_vs_minimal_summary.csv"
OUT_TEX = Path("output") / "features" / "all_vs_minimal_summary.tex"
